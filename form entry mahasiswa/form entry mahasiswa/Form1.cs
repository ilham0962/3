...
namespace form_entry_mahasiswa
{
    public partial class Form1 : Form
    {
        ...
        {
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0001", Name = "AZAR", Gender = "Laki-laki", Born="Yogyakarta",Date="01/01/1999",Alamat="Yogyakarta" });
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0002", Name = "BIANCA", Gender = "Perempuan",Born="Jakarta",Date="02/02/1999",Alamat="Ciamis" });
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0003", Name = "CITRA", Gender = "Perempuan", Born = "Surakarta", Date = "03/03/1999", Alamat = "Surakarta" });
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0004", Name = "DION", Gender = "Laki-laki", Born = "Semarang", Date = "04/04/1999", Alamat = "Bogor" });
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0005", Name = "EMILIA", Gender = "Perempuan", Born = "Madiun", Date = "05/05/1999", Alamat = "Madiun" });
